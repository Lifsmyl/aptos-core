...
* Separate core logical components for readability and expansion over time. Eliminate data from being the layer of compatibility and instead the exposed functions.
